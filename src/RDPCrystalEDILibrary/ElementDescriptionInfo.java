...
public class ElementDescriptionInfo {
  ...
  public ElementDescriptionInfo() {
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.ElementDescriptionInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ElementDescriptionInfo(NObject handle) {
